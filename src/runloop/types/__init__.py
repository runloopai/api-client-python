...
from .shared import (
    ...
    FunctionInvocationDetailView as FunctionInvocationDetailView,
)
from .devbox_view import DevboxView as DevboxView
from .code_handle_view import CodeHandleView as CodeHandleView
...
from .code_handle_list_view import CodeHandleListView as CodeHandleListView

...
class TestBenchmarkRuns:
    ...
    def test_method_retrieve(self, client: Runloop) -> None:
        benchmark_run = client.benchmark_runs.retrieve(
            "id",
        )
        assert_matches_type(BenchmarkRunView, benchmark_run, path=["response"])

    @parametrize
    def test_raw_response_retrieve(self, client: Runloop) -> None:
        response = client.benchmark_runs.with_raw_response.retrieve(
            "id",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        benchmark_run = response.parse()
        assert_matches_type(BenchmarkRunView, benchmark_run, path=["response"])

    @parametrize
    def test_streaming_response_retrieve(self, client: Runloop) -> None:
        with client.benchmark_runs.with_streaming_response.retrieve(
            "id",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Runloop) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.benchmark_runs.with_raw_response.retrieve(
                "",
            )
    ...
    def test_raw_response_list(self, client: Runloop) -> None:
        response = client.benchmark_runs.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Runloop) -> None:
        with client.benchmark_runs.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_cancel(self, client: Runloop) -> None:
        benchmark_run = client.benchmark_runs.cancel(
            "id",
        )
        assert_matches_type(BenchmarkRunView, benchmark_run, path=["response"])
    ...
    def test_raw_response_cancel(self, client: Runloop) -> None:
        response = client.benchmark_runs.with_raw_response.cancel(
            "id",
        )
    ...
    def test_streaming_response_cancel(self, client: Runloop) -> None:
        with client.benchmark_runs.with_streaming_response.cancel(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_cancel(self, client: Runloop) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.benchmark_runs.with_raw_response.cancel(
                "",
            )

    @parametrize
    def test_method_complete(self, client: Runloop) -> None:
        benchmark_run = client.benchmark_runs.complete(
            "id",
        )
        assert_matches_type(BenchmarkRunView, benchmark_run, path=["response"])
    ...
    def test_raw_response_complete(self, client: Runloop) -> None:
        response = client.benchmark_runs.with_raw_response.complete(
            "id",
        )
    ...
    def test_streaming_response_complete(self, client: Runloop) -> None:
        with client.benchmark_runs.with_streaming_response.complete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_complete(self, client: Runloop) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.benchmark_runs.with_raw_response.complete(
                "",
            )
    ...
    def test_method_list_scenario_runs(self, client: Runloop) -> None:
        ...
        assert_matches_type(SyncBenchmarkRunsCursorIDPage[ScenarioRunView], benchmark_run, path=["response"])
    ...
    def test_raw_response_list_scenario_runs(self, client: Runloop) -> None:
        response = client.benchmark_runs.with_raw_response.list_scenario_runs(
            id="id",
        )
    ...
    def test_streaming_response_list_scenario_runs(self, client: Runloop) -> None:
        with client.benchmark_runs.with_streaming_response.list_scenario_runs(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list_scenario_runs(self, client: Runloop) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.benchmark_runs.with_raw_response.list_scenario_runs(
                id="",
            )


class TestAsyncBenchmarkRuns:
    ...
    async def test_method_retrieve(self, async_client: AsyncRunloop) -> None:
        benchmark_run = await async_client.benchmark_runs.retrieve(
            "id",
        )
        assert_matches_type(BenchmarkRunView, benchmark_run, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncRunloop) -> None:
        response = await async_client.benchmark_runs.with_raw_response.retrieve(
            "id",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        benchmark_run = await response.parse()
        assert_matches_type(BenchmarkRunView, benchmark_run, path=["response"])

    @parametrize
    async def test_streaming_response_retrieve(self, async_client: AsyncRunloop) -> None:
        async with async_client.benchmark_runs.with_streaming_response.retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncRunloop) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.benchmark_runs.with_raw_response.retrieve(
                "",
            )
    ...
    async def test_raw_response_list(self, async_client: AsyncRunloop) -> None:
        response = await async_client.benchmark_runs.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncRunloop) -> None:
        async with async_client.benchmark_runs.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_cancel(self, async_client: AsyncRunloop) -> None:
        benchmark_run = await async_client.benchmark_runs.cancel(
            "id",
        )
        assert_matches_type(BenchmarkRunView, benchmark_run, path=["response"])
    ...
    async def test_raw_response_cancel(self, async_client: AsyncRunloop) -> None:
        response = await async_client.benchmark_runs.with_raw_response.cancel(
            "id",
        )
    ...
    async def test_streaming_response_cancel(self, async_client: AsyncRunloop) -> None:
        async with async_client.benchmark_runs.with_streaming_response.cancel(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_cancel(self, async_client: AsyncRunloop) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.benchmark_runs.with_raw_response.cancel(
                "",
            )

    @parametrize
    async def test_method_complete(self, async_client: AsyncRunloop) -> None:
        benchmark_run = await async_client.benchmark_runs.complete(
            "id",
        )
        assert_matches_type(BenchmarkRunView, benchmark_run, path=["response"])
    ...
    async def test_raw_response_complete(self, async_client: AsyncRunloop) -> None:
        response = await async_client.benchmark_runs.with_raw_response.complete(
            "id",
        )
    ...
    async def test_streaming_response_complete(self, async_client: AsyncRunloop) -> None:
        async with async_client.benchmark_runs.with_streaming_response.complete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_complete(self, async_client: AsyncRunloop) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.benchmark_runs.with_raw_response.complete(
                "",
            )
    ...
    async def test_method_list_scenario_runs(self, async_client: AsyncRunloop) -> None:
        ...
        assert_matches_type(AsyncBenchmarkRunsCursorIDPage[ScenarioRunView], benchmark_run, path=["response"])
    ...
    async def test_raw_response_list_scenario_runs(self, async_client: AsyncRunloop) -> None:
        response = await async_client.benchmark_runs.with_raw_response.list_scenario_runs(
            id="id",
        )
    ...
    async def test_streaming_response_list_scenario_runs(self, async_client: AsyncRunloop) -> None:
        async with async_client.benchmark_runs.with_streaming_response.list_scenario_runs(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list_scenario_runs(self, async_client: AsyncRunloop) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.benchmark_runs.with_raw_response.list_scenario_runs(
                id="",
            )

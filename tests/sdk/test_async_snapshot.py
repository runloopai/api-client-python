...
class TestAsyncSnapshot:
    ...
    @pytest.mark.asyncio
    async def test_get_info(self, mock_async_client: AsyncMock, snapshot_view: SimpleNamespace) -> None:
    ...
    @pytest.mark.asyncio
    async def test_await_completed(self, mock_async_client: AsyncMock, snapshot_view: SimpleNamespace) -> None:

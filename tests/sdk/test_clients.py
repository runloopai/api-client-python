...
class TestDevboxClient:
    ...
    def test_create(self, mock_client: Mock, devbox_view: SimpleNamespace) -> None:
        """Test create method."""
    ...
    def test_create_from_blueprint_id(self, mock_client: Mock, devbox_view: SimpleNamespace) -> None:
    ...
    def test_create_from_blueprint_name(self, mock_client: Mock, devbox_view: SimpleNamespace) -> None:
    ...
    def test_create_from_snapshot(self, mock_client: Mock, devbox_view: SimpleNamespace) -> None:
    ...
    def test_from_id(self, mock_client: Mock, devbox_view: SimpleNamespace) -> None:
    ...
    def test_list(self, mock_client: Mock, devbox_view: SimpleNamespace) -> None:
        """Test list method."""
...
class TestSnapshotClient:
    ...
    def test_list(self, mock_client: Mock, snapshot_view: SimpleNamespace) -> None:
        """Test list method."""
...
class TestBlueprintClient:
    ...
    def test_create(self, mock_client: Mock, blueprint_view: SimpleNamespace) -> None:
        """Test create method."""
    ...
    def test_list(self, mock_client: Mock, blueprint_view: SimpleNamespace) -> None:
        """Test list method."""
...
class TestStorageObjectClient:
    ...
    def test_create(self, mock_client: Mock, object_view: SimpleNamespace) -> None:
        """Test create method."""
    ...
    def test_create_auto_detect_content_type(self, mock_client: Mock, object_view: SimpleNamespace) -> None:
    ...
    def test_list(self, mock_client: Mock, object_view: SimpleNamespace) -> None:
        """Test list method."""
    ...
    def test_upload_from_file(self, mock_client: Mock, object_view: SimpleNamespace) -> None:
        ...
        try:
            with patch("httpx.put") as mock_put:
                ...
                client = StorageObjectClient(mock_client)
                obj = client.upload_from_file(temp_path, name="test.txt")
    ...
    def test_upload_from_text(self, mock_client: Mock, object_view: SimpleNamespace) -> None:
    ...
    def test_upload_from_bytes(self, mock_client: Mock, object_view: SimpleNamespace) -> None:

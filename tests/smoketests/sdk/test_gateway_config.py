...
class TestGatewayConfigLifecycle:
    """Test gateway config lifecycle operations."""

    @pytest.mark.timeout(THIRTY_SECOND_TIMEOUT)
    def test_gateway_config_full_lifecycle(self, sdk_client: RunloopSDK) -> None:
        ...
        try:
            ...
            assert info.description == "SDK smoke test gateway config"
...
class TestGatewayConfigListing:
    ...
    @pytest.mark.timeout(THIRTY_SECOND_TIMEOUT)
    def test_gateway_config_list_and_retrieve(self, sdk_client: RunloopSDK) -> None:
        ...
        try:
            ...
            # Retrieve by ID
            retrieved = sdk_client.gateway_config.from_id(config1.id)
